...
export default DS.Model.extend({
	...
	has_broadcaster_language: function() {
		...
		var m_broadcaster = re_lang.exec( broadcaster );
		var m_language    = re_lang.exec( language );
