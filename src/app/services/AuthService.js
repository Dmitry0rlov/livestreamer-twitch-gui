...
import redirect from "nwjs/redirect";
import { removeAll as removeAllCookies } from "nwjs/cookies";
import { containsAll } from "utils/contains";
import OAuth from "text!root/oauth.json";
